                ...
                >
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
                    ...
                    <div className="lg:col-span-6">
                      ...
                      >
                        <span className="text-xl md:text-2xl font-medium tracking-wide uppercase">Daftar Sekarang</span>
                        <svg className="w-6 h-6 ml-8 group-hover:translate-x-2 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
